Shader "Toon/Lit Distance Rotated Transparent"
{
    Properties
    {
        ...
        _DisAmount("Noise Texture Opacity", Range(0.0001, 1)) = 0.0001
    ...
    SubShader
    {
        ...
        void vert(inout appdata_full v) //
        {
            ...
            v.vertex.xyz = RotateAroundYInDegrees(RotateAroundZInDegrees(v.vertex.xyz, -90 + angleWhileAwayZ),
                                                  90 + angleWhileAwayY);
        }
        ...
        void surf(Input IN, inout SurfaceOutput o)
        {
            ...
            float3 position = _PositionMoving;
            position.y = IN.worldPos.y;
            float3 dis = distance(position, IN.worldPos);
            ...
            float radiusCutoff = step(_DisAmount, sphereNoise);
            float3 secondaryTex = (radiusCutoff * c2.rgb);
            ...
            // cutoff
                ...
                clip(1-(radiusCutoff - DissolveLine) - 0.01);
            #endif
            o.Alpha = c.a;
        }
        ENDCG
